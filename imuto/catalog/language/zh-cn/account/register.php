...
$_['text_account']         			= '账户';
$_['text_register']        			= '注册';
$_['text_account_already'] 			= '欢迎来到我们网站，如果您是新会员，请填写下面的表单进行注册。如果您已经是本站的会员，请您直接<a class="font-color-purple font-bold" href="%s">登录</a>。';
$_['text_your_details']    			= '您的个人资料';
$_['text_newsletter']     			= '新闻订阅';
$_['text_your_password']   			= '账户密码';
$_['text_agree']           			= '我已经阅读并同意 <a href="%s" class="font-color-purple" target="_blank"><b>%s</b></a>条款';
