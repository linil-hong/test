...
class ControllerCatalogCategory extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['jpimage']) && is_file(DIR_IMAGE . $this->request->post['jpimage'])) {
			$data['jpthumb'] = $this->model_tool_image->resize($this->request->post['jpimage'], 100, 100);
		} elseif (!empty($category_info) && is_file(DIR_IMAGE . $category_info['jpimage'])) {
			$data['jpthumb'] = $this->model_tool_image->resize($category_info['jpimage'], 100, 100);
		} else {
			$data['jpthumb'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
