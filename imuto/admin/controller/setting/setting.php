...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_discount_activity_description'])) {
			$data['config_discount_activity_description'] = $this->request->post['config_discount_activity_description'];
		} else {
