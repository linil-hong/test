...
class ModelCatalogDownload extends Model {
	public function addDownload($data) {
		$this->db->query("INSERT INTO " . DB_PREFIX . "download SET filename = '" . $this->db->escape($data['filename']) . "', mask = '" . $this->db->escape($data['mask']) . "', date_added = NOW()" . ", image = '" . $this->db->escape($data['image']) . "', content = '" . $this->db->escape($data['content']) . "'");
	...
	public function editDownload($download_id, $data) {
		$this->db->query("UPDATE " . DB_PREFIX . "download SET filename = '" . $this->db->escape($data['filename']) . "', mask = '" . $this->db->escape($data['mask']) . "', image = '" . $this->db->escape($data['image']) . "', content = '" . $this->db->escape($data['content']) . "' WHERE download_id = '" . (int)$download_id . "'");
